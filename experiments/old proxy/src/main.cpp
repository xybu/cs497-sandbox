...
int main(int argc, char **argv) {
	...
	OutSocketHandler out_sock(fw_host, fw_port);
	InSocketHandler in_sock(port);

	std::thread in_thread(&InSocketHandler::start_loop, &in_sock);
	std::thread out_thread(&OutSocketHandler::start_loop, &out_sock);
